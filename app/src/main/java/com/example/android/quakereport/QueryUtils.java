...
*/
    ...
    private static ArrayList<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for(int i = 0; i < featureArray.length(); i++ ) {
                ...
                JSONObject earthquakeFeature = featureArray.getJSONObject(i);
                // For a given earthquake, extract the JSONObject associated with the
                // key called "properties", which represents a list of all properties
                // for that earthquake.
                JSONObject earthquakeFeatureProperties = earthquakeFeature.getJSONObject("properties");

                // Create a new {@link Earthquake} object with the magnitude, location, time,
                // and url from the JSON response.
                earthquakes.add(new Earthquake(earthquakeFeatureProperties.getDouble("mag"),
                        earthquakeFeatureProperties.optString("place"),
                        earthquakeFeatureProperties.getLong("time"),
                        earthquakeFeatureProperties.optString("url")));
   ...
   /* *//**
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for(int i = 0; i < earthquakeArray.length(); i++ ) {
                JSONObject earthquakeDetails = earthquakeArray.getJSONObject(i);
                JSONObject earthquakeDetailsProperties = earthquakeDetails.getJSONObject("properties");

                earthquakes.add(new Earthquake(Double.parseDouble(earthquakeDetailsProperties.optString("mag").toString()),
                        earthquakeDetailsProperties.optString("place").toString(),
                        Long.parseLong(earthquakeDetailsProperties.optString("time").toString()),
                        earthquakeDetailsProperties.optString("url").toString()));
            }
    ...
    public static ArrayList<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        Log.e(LOG_TAG, "fetchEarthquakeData called");
        // Create URL object
